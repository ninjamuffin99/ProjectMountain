...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("", "ProjectMountain", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "ProjectMountain";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "ProjectMountain", null, { width: 800, height: 512 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 800, height: 512 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 800, 512, "null");
		#end
		#else
		create ();
		#end

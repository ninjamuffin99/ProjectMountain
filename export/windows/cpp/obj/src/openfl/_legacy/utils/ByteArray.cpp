...
HXLINE( 307)		return ::openfl::_legacy::utils::ByteArray_obj::_double_of_bytes(bytes2->b,this->bigEndian);
            	}
...
HXLINE( 344)		return ::openfl::_legacy::utils::ByteArray_obj::_float_of_bytes(bytes2->b,this->bigEndian);
            	}

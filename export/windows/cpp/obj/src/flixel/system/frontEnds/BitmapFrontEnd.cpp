...
HXLINE(  48)		 ::Dynamic key = this->_cache->keys();
HXDLIN(  48)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  48)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE(  64)		 ::Dynamic key = this->_cache->keys();
...
HXLINE(  81)		 ::Dynamic key = this->_cache->keys();
HXDLIN(  81)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  81)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE(  98)		 ::Dynamic key = this->_cache->keys();
...
HXLINE( 360)		 ::Dynamic key = this->_cache->keys();
HXDLIN( 360)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 360)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );

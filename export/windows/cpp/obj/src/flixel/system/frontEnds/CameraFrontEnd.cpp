...
HXLINE( 141)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 158)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 176)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 236)		int _g = (int)0;
HXDLIN( 236)		::Array< ::Dynamic> _g1 = this->list;
HXDLIN( 236)		while((_g < _g1->length)){
HXLINE( 236)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 263)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 278)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();

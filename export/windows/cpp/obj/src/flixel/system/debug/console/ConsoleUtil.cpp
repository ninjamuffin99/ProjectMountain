...
HX_LOCAL_STACK_FRAME(_hx_pos_a994ee380c23f681_73_registerObject,"flixel.system.debug.console.ConsoleUtil","registerObject",0x0d502bb6,"flixel.system.debug.console.ConsoleUtil.registerObject","flixel/system/debug/console/ConsoleUtil.hx",73,0x2e8bcde6)
HX_LOCAL_STACK_FRAME(_hx_pos_a994ee380c23f681_85_registerFunction,"flixel.system.debug.console.ConsoleUtil","registerFunction",0xb3a1c3cf,"flixel.system.debug.console.ConsoleUtil.registerFunction","flixel/system/debug/console/ConsoleUtil.hx",85,0x2e8bcde6)
...
void ConsoleUtil_obj::registerObject(::String ObjectAlias, ::Dynamic AnyObject){
            	HX_STACKFRAME(&_hx_pos_a994ee380c23f681_73_registerObject)
HXLINE(  73)		if (::Reflect_obj::isObject(AnyObject)) {
...
void ConsoleUtil_obj::registerFunction(::String FunctionAlias, ::Dynamic Function){
            	HX_STACKFRAME(&_hx_pos_a994ee380c23f681_85_registerFunction)
HXLINE(  85)		if (::Reflect_obj::isFunction(Function)) {

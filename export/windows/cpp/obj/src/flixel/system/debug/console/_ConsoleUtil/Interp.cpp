...
HX_DEFINE_STACK_FRAME(_hx_pos_87978f3c8c973553_151_new,"flixel.system.debug.console._ConsoleUtil.Interp","new",0x56cfaa5b,"flixel.system.debug.console._ConsoleUtil.Interp.new","flixel/system/debug/console/ConsoleUtil.hx",151,0x2e8bcde6)
HX_LOCAL_STACK_FRAME(_hx_pos_87978f3c8c973553_155_getGlobals,"flixel.system.debug.console._ConsoleUtil.Interp","getGlobals",0x79b1b71f,"flixel.system.debug.console._ConsoleUtil.Interp.getGlobals","flixel/system/debug/console/ConsoleUtil.hx",155,0x2e8bcde6)
HX_LOCAL_STACK_FRAME(_hx_pos_87978f3c8c973553_159_toArray,"flixel.system.debug.console._ConsoleUtil.Interp","toArray",0x1b83ad99,"flixel.system.debug.console._ConsoleUtil.Interp.toArray","flixel/system/debug/console/ConsoleUtil.hx",159,0x2e8bcde6)
HX_LOCAL_STACK_FRAME(_hx_pos_87978f3c8c973553_167_get,"flixel.system.debug.console._ConsoleUtil.Interp","get",0x56ca5a91,"flixel.system.debug.console._ConsoleUtil.Interp.get","flixel/system/debug/console/ConsoleUtil.hx",167,0x2e8bcde6)
HX_LOCAL_STACK_FRAME(_hx_pos_87978f3c8c973553_174_set,"flixel.system.debug.console._ConsoleUtil.Interp","set",0x56d3759d,"flixel.system.debug.console._ConsoleUtil.Interp.set","flixel/system/debug/console/ConsoleUtil.hx",174,0x2e8bcde6)
namespace flixel{
...
void Interp_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_87978f3c8c973553_151_new)
...
::Array< ::String > Interp_obj::getGlobals(){
            	HX_STACKFRAME(&_hx_pos_87978f3c8c973553_155_getGlobals)
HXLINE( 155)		::Array< ::String > _hx_tmp = this->toArray(this->locals->keys());
HXDLIN( 155)		return _hx_tmp->concat(this->toArray(this->variables->keys()));
            	}
...
::cpp::VirtualArray Interp_obj::toArray( ::Dynamic iterator){
            	HX_STACKFRAME(&_hx_pos_87978f3c8c973553_159_toArray)
HXLINE( 160)		::cpp::VirtualArray array = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 161)		{
HXLINE( 161)			 ::Dynamic element = iterator;
HXDLIN( 161)			while(( (bool)(element->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 161)				 ::Dynamic element1 = element->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE( 162)				array->push(element1);
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Interp_obj,toArray,return )
 ...
 ::Dynamic Interp_obj::get( ::Dynamic o,::String f){
            	HX_STACKFRAME(&_hx_pos_87978f3c8c973553_167_get)
HXLINE( 168)		if (hx::IsNull( o )) {
HXLINE( 169)			HX_STACK_DO_THROW(::hscript::Error_obj::EInvalidAccess(f));
            		}
HXLINE( 170)		return ::Reflect_obj::getProperty(o,f);
 ...
 ::Dynamic Interp_obj::set( ::Dynamic o,::String f, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_87978f3c8c973553_174_set)
HXLINE( 175)		if (hx::IsNull( o )) {
HXLINE( 176)			HX_STACK_DO_THROW(::hscript::Error_obj::EInvalidAccess(f));
            		}

...
HX_LOCAL_STACK_FRAME(_hx_pos_d4c828664754b74a_109_getGlobals,"flixel.system.debug.completion.CompletionHandler","getGlobals",0x3af6d144,"flixel.system.debug.completion.CompletionHandler.getGlobals","flixel/system/debug/completion/CompletionHandler.hx",109,0x776a5e1a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d4c828664754b74a_140_selectionChanged,"flixel.system.debug.completion.CompletionHandler","selectionChanged",0xb4bbcb12,"flixel.system.debug.completion.CompletionHandler.selectionChanged","flixel/system/debug/completion/CompletionHandler.hx",140,0x776a5e1a)
...
HXLINE(  77)		::Array< ::String > items = null();
HXLINE(  79)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE(  81)			if ((path.length != (int)0)) {
HXLINE(  83)				 ::Dynamic output = ::flixel::_hx_system::debug::console::ConsoleUtil_obj::runCommand(path);
...
HXLINE(  96)		if (hx::IsNull( items )) {
HXLINE(  97)			items = this->getGlobals();
            		}
HXLINE(  99)		if ((items->length > (int)0)) {
HXLINE( 100)			 ::flixel::_hx_system::debug::completion::CompletionList _hx_tmp = this->completionList;
HXDLIN( 100)			_hx_tmp->show(this->getCharXPosition(),items);
            		}
            		else {
...
::Array< ::String > CompletionHandler_obj::getGlobals(){
            	HX_STACKFRAME(&_hx_pos_d4c828664754b74a_109_getGlobals)
HXLINE( 109)		return ::flixel::util::FlxStringUtil_obj::sortAlphabetically(::flixel::_hx_system::debug::console::ConsoleUtil_obj::interp->getGlobals());
            	}
...
void CompletionHandler_obj::selectionChanged(::String selectedItem){
            	HX_STACKFRAME(&_hx_pos_d4c828664754b74a_140_selectionChanged)
HXLINE( 140)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 142)			::String lastWord = this->getLastWord(this->input->get_text());
HXLINE( 143)			::String command = this->getCompletedText(lastWord,selectedItem);
HXLINE( 144)			 ::Dynamic output = ::flixel::_hx_system::debug::console::ConsoleUtil_obj::runCommand(command);
HXLINE( 146)			this->watchingSelection = true;
HXLINE( 147)			{
HXLINE( 147)				 ::flixel::_hx_system::frontEnds::WatchFrontEnd _this = ::flixel::FlxG_obj::watch;
HXDLIN( 147)				 ::flixel::_hx_system::debug::watch::Watch _hx_tmp = ::flixel::FlxG_obj::game->debugger->watch;
HXDLIN( 147)				_hx_tmp->add(HX_("Selection",2c,d8,ed,2f),::flixel::_hx_system::debug::watch::WatchEntryData_obj::QUICK(output));
            			}
            		}
            		catch( ::Dynamic _hx_e){
            			if (_hx_e.IsClass<  ::Dynamic >() ){

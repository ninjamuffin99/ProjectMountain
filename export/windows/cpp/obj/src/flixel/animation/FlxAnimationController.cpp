...
HXLINE( 654)			::String frameName = FrameNames->__get(_g);
...
HXLINE( 669)			::String index = Indices->__get(_g);
...
HXLINE( 685)			int index = Indices->__get(_g);
...
HXLINE( 716)		int _g = (int)0;
HXDLIN( 716)		::Array< ::Dynamic> _g1 = this->_sprite->frames->frames;
HXDLIN( 716)		while((_g < _g1->length)){
HXLINE( 716)			 ::flixel::graphics::frames::FlxFrame frame = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();

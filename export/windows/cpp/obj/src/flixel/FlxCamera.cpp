...
HXLINE(1531)		 ::Dynamic Max = ((Float)(int)60 / (Float)::flixel::FlxG_obj::updateFramerate);
...
HXLINE( 420)			::Array< Float > this1 = ::Array_obj< Float >::__new();
...
HXLINE( 429)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);

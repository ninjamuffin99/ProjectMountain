...
HXLINE(1156)		int _g = (int)0;
HXDLIN(1156)		::Array< ::Dynamic> _g1 = this->_tweens;
HXDLIN(1156)		while((_g < _g1->length)){
HXLINE(1156)			 ::flixel::tweens::FlxTween tween = _g1->__get(_g).StaticCast<  ::flixel::tweens::FlxTween >();
...
HXLINE(1169)		int _g = (int)0;
HXDLIN(1169)		::Array< ::Dynamic> _g1 = this->_tweens;
HXDLIN(1169)		while((_g < _g1->length)){
HXLINE(1169)			 ::flixel::tweens::FlxTween tween = _g1->__get(_g).StaticCast<  ::flixel::tweens::FlxTween >();

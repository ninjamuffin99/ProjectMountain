...
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_441_onFocus,"flixel.input.mouse.FlxMouse","onFocus",0xede20cdd,"flixel.input.mouse.FlxMouse.onFocus","flixel/input/mouse/FlxMouse.hx",441,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_455_onFocusLost,"flixel.input.mouse.FlxMouse","onFocusLost",0xc7f71561,"flixel.input.mouse.FlxMouse.onFocusLost","flixel/input/mouse/FlxMouse.hx",455,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_472_onGameStart,"flixel.input.mouse.FlxMouse","onGameStart",0x61da7695,"flixel.input.mouse.FlxMouse.onGameStart","flixel/input/mouse/FlxMouse.hx",472,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_480_onMouseWheel,"flixel.input.mouse.FlxMouse","onMouseWheel",0xdc642911,"flixel.input.mouse.FlxMouse.onMouseWheel","flixel/input/mouse/FlxMouse.hx",480,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_493_onMouseLeave,"flixel.input.mouse.FlxMouse","onMouseLeave",0x84fd296d,"flixel.input.mouse.FlxMouse.onMouseLeave","flixel/input/mouse/FlxMouse.hx",493,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_499_get_pressed,"flixel.input.mouse.FlxMouse","get_pressed",0x4652635d,"flixel.input.mouse.FlxMouse.get_pressed","flixel/input/mouse/FlxMouse.hx",499,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_500_get_justPressed,"flixel.input.mouse.FlxMouse","get_justPressed",0x70091811,"flixel.input.mouse.FlxMouse.get_justPressed","flixel/input/mouse/FlxMouse.hx",500,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_501_get_justReleased,"flixel.input.mouse.FlxMouse","get_justReleased",0x9ec2046e,"flixel.input.mouse.FlxMouse.get_justReleased","flixel/input/mouse/FlxMouse.hx",501,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_504_get_pressedRight,"flixel.input.mouse.FlxMouse","get_pressedRight",0x90e8c73f,"flixel.input.mouse.FlxMouse.get_pressedRight","flixel/input/mouse/FlxMouse.hx",504,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_505_get_justPressedRight,"flixel.input.mouse.FlxMouse","get_justPressedRight",0xa8a2860b,"flixel.input.mouse.FlxMouse.get_justPressedRight","flixel/input/mouse/FlxMouse.hx",505,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_506_get_justReleasedRight,"flixel.input.mouse.FlxMouse","get_justReleasedRight",0x8742a88e,"flixel.input.mouse.FlxMouse.get_justReleasedRight","flixel/input/mouse/FlxMouse.hx",506,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_508_get_pressedMiddle,"flixel.input.mouse.FlxMouse","get_pressedMiddle",0x38fe0e92,"flixel.input.mouse.FlxMouse.get_pressedMiddle","flixel/input/mouse/FlxMouse.hx",508,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_509_get_justPressedMiddle,"flixel.input.mouse.FlxMouse","get_justPressedMiddle",0xe3cb4246,"flixel.input.mouse.FlxMouse.get_justPressedMiddle","flixel/input/mouse/FlxMouse.hx",509,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_510_get_justReleasedMiddle,"flixel.input.mouse.FlxMouse","get_justReleasedMiddle",0xd1495263,"flixel.input.mouse.FlxMouse.get_justReleasedMiddle","flixel/input/mouse/FlxMouse.hx",510,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_514_showSystemCursor,"flixel.input.mouse.FlxMouse","showSystemCursor",0xf4551c9e,"flixel.input.mouse.FlxMouse.showSystemCursor","flixel/input/mouse/FlxMouse.hx",514,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_525_hideSystemCursor,"flixel.input.mouse.FlxMouse","hideSystemCursor",0xb5438fe3,"flixel.input.mouse.FlxMouse.hideSystemCursor","flixel/input/mouse/FlxMouse.hx",525,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_542_set_useSystemCursor,"flixel.input.mouse.FlxMouse","set_useSystemCursor",0x074e74d3,"flixel.input.mouse.FlxMouse.set_useSystemCursor","flixel/input/mouse/FlxMouse.hx",542,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_556_showCursor,"flixel.input.mouse.FlxMouse","showCursor",0xa585e38f,"flixel.input.mouse.FlxMouse.showCursor","flixel/input/mouse/FlxMouse.hx",556,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_575_hideCursor,"flixel.input.mouse.FlxMouse","hideCursor",0xd396e514,"flixel.input.mouse.FlxMouse.hideCursor","flixel/input/mouse/FlxMouse.hx",575,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_581_set_visible,"flixel.input.mouse.FlxMouse","set_visible",0xb9fd1039,"flixel.input.mouse.FlxMouse.set_visible","flixel/input/mouse/FlxMouse.hx",581,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_592_record,"flixel.input.mouse.FlxMouse","record",0xf2d1086d,"flixel.input.mouse.FlxMouse.record","flixel/input/mouse/FlxMouse.hx",592,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_608_playback,"flixel.input.mouse.FlxMouse","playback",0xaadcd2f7,"flixel.input.mouse.FlxMouse.playback","flixel/input/mouse/FlxMouse.hx",608,0xe4e80b89)
namespace flixel{
namespace input{
namespace mouse{
...
HXDLIN( 412)			this->_globalScreenX = ::Std_obj::_hx_int(((Float)newX / (Float)::flixel::FlxG_obj::scaleMode->scale->x));
HXDLIN( 412)			this->_globalScreenY = ::Std_obj::_hx_int(((Float)newY / (Float)::flixel::FlxG_obj::scaleMode->scale->y));
...
HXLINE( 426)		this->_rightButton->update();
HXLINE( 430)		if (!(this->_wheelUsed)) {
HXLINE( 432)			this->wheel = (int)0;
            		}
HXLINE( 434)		this->_wheelUsed = false;
            	}
...
void FlxMouse_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_441_onFocus)
HXLINE( 442)		this->reset();
HXLINE( 445)		this->set_useSystemCursor(this->useSystemCursor);
HXLINE( 447)		this->set_visible(this->_visibleWhenFocusLost);
            	}
...
void FlxMouse_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_455_onFocusLost)
HXLINE( 457)		this->_visibleWhenFocusLost = this->visible;
HXLINE( 459)		if (this->visible) {
HXLINE( 461)			this->set_visible(false);
            		}
HXLINE( 464)		::openfl::_legacy::ui::Mouse_obj::show();
            	}
...
void FlxMouse_obj::onGameStart(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_472_onGameStart)
HXLINE( 472)		this->set_visible(this->visible);
            	}
...
void FlxMouse_obj::onMouseWheel( ::openfl::_legacy::events::MouseEvent FlashEvent){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_480_onMouseWheel)
HXLINE( 480)		if (this->enabled) {
HXLINE( 482)			this->_wheelUsed = true;
HXLINE( 483)			this->wheel = FlashEvent->delta;
            		}
            	}
...
void FlxMouse_obj::onMouseLeave( ::Dynamic _){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_493_onMouseLeave)
HXLINE( 494)		this->_rightButton->onUp(null());
HXLINE( 495)		this->_middleButton->onUp(null());
            	}
...
bool FlxMouse_obj::get_pressed(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_499_get_pressed)
HXLINE( 499)		 ::flixel::input::mouse::FlxMouseButton _this = this->_leftButton;
HXDLIN( 499)		if ((_this->current != (int)1)) {
HXLINE( 499)			return (_this->current == (int)2);
            		}
            		else {
HXLINE( 499)			return true;
            		}
HXDLIN( 499)		return false;
            	}
...
bool FlxMouse_obj::get_justPressed(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_500_get_justPressed)
HXLINE( 500)		return (this->_leftButton->current == (int)2);
            	}
...
bool FlxMouse_obj::get_justReleased(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_501_get_justReleased)
HXLINE( 501)		return (this->_leftButton->current == (int)-1);
            	}
...
bool FlxMouse_obj::get_pressedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_504_get_pressedRight)
HXLINE( 504)		 ::flixel::input::mouse::FlxMouseButton _this = this->_rightButton;
HXDLIN( 504)		if ((_this->current != (int)1)) {
HXLINE( 504)			return (_this->current == (int)2);
            		}
            		else {
HXLINE( 504)			return true;
            		}
HXDLIN( 504)		return false;
            	}
...
bool FlxMouse_obj::get_justPressedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_505_get_justPressedRight)
HXLINE( 505)		return (this->_rightButton->current == (int)2);
            	}
...
bool FlxMouse_obj::get_justReleasedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_506_get_justReleasedRight)
HXLINE( 506)		return (this->_rightButton->current == (int)-1);
            	}
...
bool FlxMouse_obj::get_pressedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_508_get_pressedMiddle)
HXLINE( 508)		 ::flixel::input::mouse::FlxMouseButton _this = this->_middleButton;
HXDLIN( 508)		if ((_this->current != (int)1)) {
HXLINE( 508)			return (_this->current == (int)2);
            		}
            		else {
...
bool FlxMouse_obj::get_justPressedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_509_get_justPressedMiddle)
HXLINE( 509)		return (this->_middleButton->current == (int)2);
            	}
...
bool FlxMouse_obj::get_justReleasedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_510_get_justReleasedMiddle)
HXLINE( 510)		return (this->_middleButton->current == (int)-1);
            	}
...
void FlxMouse_obj::showSystemCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_514_showSystemCursor)
HXLINE( 518)		this->cursorContainer->set_visible(false);
HXLINE( 521)		::openfl::_legacy::ui::Mouse_obj::show();
            	}
...
void FlxMouse_obj::hideSystemCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_525_hideSystemCursor)
HXLINE( 532)		::openfl::_legacy::ui::Mouse_obj::hide();
HXLINE( 534)		if (this->visible) {
HXLINE( 536)			this->cursorContainer->set_visible(true);
            		}
            	}
...
bool FlxMouse_obj::set_useSystemCursor(bool Value){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_542_set_useSystemCursor)
HXLINE( 543)		if (Value) {
HXLINE( 545)			this->showSystemCursor();
            		}
            		else {
HXLINE( 549)			this->hideSystemCursor();
            		}
HXLINE( 551)		return (this->useSystemCursor = Value);
            	}
...
void FlxMouse_obj::showCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_556_showCursor)
HXLINE( 556)		if (this->useSystemCursor) {
HXLINE( 558)			::openfl::_legacy::ui::Mouse_obj::show();
            		}
            		else {
HXLINE( 562)			if (hx::IsNull( this->_cursor )) {
HXLINE( 563)				this->load(null(),null(),null(),null());
            			}
HXLINE( 568)			this->cursorContainer->set_visible(true);
HXLINE( 569)			::openfl::_legacy::ui::Mouse_obj::hide();
            		}
            	}
...
void FlxMouse_obj::hideCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_575_hideCursor)
HXLINE( 576)		this->cursorContainer->set_visible(false);
HXLINE( 577)		::openfl::_legacy::ui::Mouse_obj::hide();
            	}
...
bool FlxMouse_obj::set_visible(bool Value){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_581_set_visible)
HXLINE( 582)		if (Value) {
HXLINE( 583)			this->showCursor();
            		}
            		else {
HXLINE( 585)			this->hideCursor();
            		}
HXLINE( 587)		return (this->visible = Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxMouse_obj,set_visible,return )
 ...
 ::flixel::_hx_system::replay::MouseRecord FlxMouse_obj::record(){
            	HX_GC_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_592_record)
HXLINE( 593)		bool _hx_tmp;
HXDLIN( 593)		bool _hx_tmp1;
HXDLIN( 593)		bool _hx_tmp2;
HXDLIN( 593)		if ((this->_lastX == this->_globalScreenX)) {
HXLINE( 593)			_hx_tmp2 = (this->_lastY == this->_globalScreenY);
            		}
            		else {
HXLINE( 593)			_hx_tmp2 = false;
            		}
HXDLIN( 593)		if (_hx_tmp2) {
HXLINE( 593)			_hx_tmp1 = (this->_lastLeftButtonState == this->_leftButton->current);
            		}
            		else {
HXLINE( 593)			_hx_tmp1 = false;
            		}
HXDLIN( 593)		if (_hx_tmp1) {
HXLINE( 593)			_hx_tmp = (this->_lastWheel == this->wheel);
            		}
            		else {
...
HXLINE( 599)		this->_lastX = this->_globalScreenX;
HXLINE( 600)		this->_lastY = this->_globalScreenY;
HXLINE( 601)		this->_lastLeftButtonState = this->_leftButton->current;
HXLINE( 602)		this->_lastWheel = this->wheel;
HXLINE( 603)		return  ::flixel::_hx_system::replay::MouseRecord_obj::__alloc( HX_CTX ,this->_lastX,this->_lastY,this->_leftButton->current,this->_lastWheel);
            	}
...
void FlxMouse_obj::playback( ::flixel::_hx_system::replay::MouseRecord Record){
            	HX_GC_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_608_playback)
HXLINE( 612)		bool _hx_tmp;
HXDLIN( 612)		bool _hx_tmp1;
HXDLIN( 612)		if ((this->_lastLeftButtonState != (int)1)) {
HXLINE( 612)			_hx_tmp1 = (this->_lastLeftButtonState == (int)2);
            		}
            		else {
HXLINE( 612)			_hx_tmp1 = true;
            		}
HXDLIN( 612)		if (_hx_tmp1) {
HXLINE( 613)			if ((Record->button != (int)0)) {
HXLINE( 612)				_hx_tmp = (Record->button == (int)-1);
            			}
            			else {
...
HXLINE( 615)			 ::openfl::_legacy::display::Stage _hx_tmp2 = this->_stage;
HXDLIN( 615)			_hx_tmp2->dispatchEvent( ::openfl::_legacy::events::MouseEvent_obj::__alloc( HX_CTX ,::openfl::_legacy::events::MouseEvent_obj::MOUSE_UP,true,false,Record->x,Record->y,null(),null(),null(),null(),null(),null(),null(),null()));
            		}
HXLINE( 617)		this->_lastLeftButtonState = (this->_leftButton->current = Record->button);
HXLINE( 618)		this->wheel = Record->wheel;
HXLINE( 619)		this->_globalScreenX = Record->x;
HXLINE( 620)		this->_globalScreenY = Record->y;
HXLINE( 621)		this->updatePositions();
            	}

...
HXLINE( 800)			return (objectScreenPos4 < (_hx_tmp8 + this->get_height()));
            		}
            		else {
...
HXLINE( 843)			 ::flixel::math::FlxRect _this = ::flixel::FlxG_obj::worldBounds;
...
HXLINE( 843)			 ::flixel::math::FlxRect _this1 = ::flixel::FlxG_obj::worldBounds;

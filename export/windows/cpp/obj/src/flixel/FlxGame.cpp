...
HXLINE( 657)		{
HXLINE( 657)			 ::Dynamic anyObject = this->_state;
HXDLIN( 657)			::haxe::IMap_obj::set(this->debugger->console->registeredObjects,HX_("state",11,76,0b,84),anyObject);
...
HXLINE( 842)			::Dynamic input = _g1->__get(_g);
